...
set(source_file "${RunClangTidy_BINARY_DIR}/${CHECK_NAME}.c")
configure_file("${CMAKE_CURRENT_LIST_DIR}/${CHECK_NAME}.c" "${source_file}" COPYONLY)

file(GLOB header_files RELATIVE "${CMAKE_CURRENT_LIST_DIR}/${CHECK_NAME}" "${CMAKE_CURRENT_LIST_DIR}/${CHECK_NAME}/*")
file(REMOVE_RECURSE "${RunClangTidy_BINARY_DIR}/${CHECK_NAME}")
...
check_fixit(
  "${CMAKE_CURRENT_LIST_DIR}/${CHECK_NAME}-fixit.c"
  "${CMAKE_CURRENT_LIST_DIR}/${CHECK_NAME}.c"
  "${source_file}"
  )
